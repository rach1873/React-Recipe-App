...
function Recipe(props) {
    ...
    return (
        <div className='border-2 h-auto border-white m-2 flex flex-col justify-between items-center px-6 py-2 bg-gray-300 rounded-lg shadow-xl space-y-2 cursor-pointer'>
